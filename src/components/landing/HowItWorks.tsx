...
const steps = [
  {
    icon: <ScanFace className="h-12 w-12 text-pink-400" />,
  ...
  {
    icon: <Send className="h-12 w-12 text-pink-400" />,
  ...
  {
    icon: <UserCheck className="h-12 w-12 text-pink-400" />,
        ...
        <div className="mt-16 grid gap-12 md:grid-cols-3">
          {steps.map((step, index) => (
            <AnimatedWrapper key={index} delay={index * 150}>
              <div className="text-center p-8 border border-gray-800 rounded-xl bg-gray-900/40 transition-all hover:border-pink-500/50 hover:bg-gray-900/80">
